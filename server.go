...
import (
	...
	pkgConf "gitlab.nongchangshijie.com/go-base/server/pkg/conf"
	"gitlab.nongchangshijie.com/go-base/server/pkg/db"
	"gitlab.nongchangshijie.com/go-base/server/pkg/ginx/middleware"
	"gitlab.nongchangshijie.com/go-base/server/pkg/ginx/route"
	"gitlab.nongchangshijie.com/go-base/server/pkg/grpcx"
	"gitlab.nongchangshijie.com/go-base/server/pkg/grpcx/interceptor"
	log2 "gitlab.nongchangshijie.com/go-base/server/pkg/log"
	kafka "gitlab.nongchangshijie.com/go-base/server/pkg/mq"
	"gitlab.nongchangshijie.com/go-base/server/pkg/netx"
